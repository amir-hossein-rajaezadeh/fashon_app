        ...
        children: [
          ...
          Expanded(
            child: itemSearchList.isNotEmpty
                ? searchItem(size, textTheme, true, context, viewModel)
                : viewModel.getSearchTextContrrollerValue().text.isEmpty
                    ? searchItem(size, textTheme, false, context, viewModel)
                    : Column(
                        children: [
                          const Image(
          ...
          child: InkWell(
            onTap: () {
              Navigator.pushNamed(
                context,
                "/detail",
                arguments: DetailArguments(current, false),
              );
            },
            child: Stack(
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: CircleAvatar(
                    ...
                    child: IconButton(
                      onPressed: () {
                        viewModel.addItemToCarrtList(
                            current, context, true, index);
                      },
                      icon: const Icon(
